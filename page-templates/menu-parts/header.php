...
<div class="restaurant-details relative isolate overflow-hidden bg-[#000000] pt-2 pb-6 sm:pt-4"
    ...
    <div class="flex justify-between relative z-[999] h-full items-end mx-auto max-w-4xl lg:max-w-7xl">
        <div class="restaurant-details-inner mx-auto max-w-4xl lg:max-w-7xl z-50 px-12 lg:px-8">

            <div
                class="flex flex-row items-center rtl:flex-row-reverse <?php echo ($isCategoryPage) ? "!justify-end" : "" ?> <?php echo ($categorized || $add_back_button) ? "justify-between" : "justify-end" ?>">
                <?php if (!$isCategoryPage) { ?>
                    <?php if ($categorized || $add_back_button) { ?>
                        <a href="<?php echo esc_url(home_url('/')); ?>"
                            class="hover:opacity-75 active:scale-95 transition transform duration-150 ease-out">
                            <div
                                class="flex flex-row rtl:flex-row-reverse justify-center items-center border border-gray-100 w-8 sm:w-10 h-8 sm:h-10 rounded-full  bg-gray-900 text-sm items-center gap-2 font-medium text-white">
                ...
                <div class="flex flex-row rtl:flex-row-reverse justify-end items-center gap-2 sm:gap-3">
                    ...
                    <?php if ($show_most_used_buttons_in_header): ?>
                            ...
                            <?php if ($whatsapp__number): ?>
                                <a href="https://wa.me/<?php echo esc_attr($whatsapp__number) ?>" class="quick-access-whatsapp">
                                    <div
                                        ...
                                        <svg class="size-5 sm:size-6" viewBox="0 0 360 362" fill="none"
                                    ...
                                    <a href="<?php echo esc_url($row['link']); ?>" target="_blank" class="quick-access-instagram">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                ...
                                                class="w-8 sm:w-10 h-8 sm:h-10 rounded-xl" viewBox="0 0 264.5833 264.5833"
                                                inkscape:version="1.0.1 (3bc2e813f5, 2020-09-07)"
                                                sodipodi:docname="Instagram_(2022).svg">
                                                <defs>
                                                    <radialGradient id="f" cx="158.429" cy="578.088" r="52.3515" xlink:href="#a"
                                                        gradientUnits="userSpaceOnUse"
                                                        gradientTransform="matrix(0 -4.03418 4.28018 0 -2332.2273 942.2356)"
                                                        fx="158.429" fy="578.088" />
                                                    <radialGradient inkscape:collect="always" xlink:href="#b" id="g"
                                                        gradientUnits="userSpaceOnUse"
                                                        gradientTransform="matrix(.67441 -1.16203 1.51283 .87801 -814.3657 -47.8354)"
                                                        cx="172.6149" cy="600.6924" fx="172.6149" fy="600.6924" r="65" />
                                                    <radialGradient inkscape:collect="always" xlink:href="#c" id="h" cx="144.012"
                                                        cy="51.3367" fx="144.012" fy="51.3367" r="67.081"
                                                        gradientTransform="matrix(-2.3989 .67549 -.23008 -.81732 464.9957 -26.4035)"
                                                        gradientUnits="userSpaceOnUse" />
                                                    <radialGradient inkscape:collect="always" xlink:href="#d" id="e"
                                                        gradientUnits="userSpaceOnUse"
                                                        gradientTransform="matrix(-3.10797 .87652 -.6315 -2.23914 1345.6503 1374.1983)"
                                                        cx="199.7884" cy="628.4379" fx="199.7884" fy="628.4379" r="52.3515" />
                        ...
                        <button type="button" data-micromodal-trigger="menu-survey" aria-label="Survey"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-5 sm:size-6" viewBox="0 0 24 24"
                                fill="none">
                                <path
                    ...
                    <button type="button" data-micromodal-trigger="menu-info" aria-label="See more informations"
                        class="hidden rounded-xl bg-white w-8 sm:w-10 h-8 sm:h-10 hover:opacity-70 shadow-lg flex flex-col justify-center items-center">
            ...
            <div class="flex justify-between items-end">
                <div
                    class="flex-1 flex flex-col items-start <?php echo !$categorized ? 'justify-end' : 'justify-between' ?> ">
                    <div>
                        <?php if (!$categorized): ?>
                            <?php if ($brand_logo): ?>
                                <?php if ($logo_round): ?>
                            ...
                            <?php if (is_page_template('page-templates/page-category.php')) { ?>
                                <?php if ($logo_round): ?>
                                    ...
                                    <div class="brand-logo inline-block rounded-full p-1"
                                        style="background-color: <?php echo esc_attr($logo_background_color); ?>;">
                                        <img class="inline-block sm:h-[100px] h-[70px] w-[70px] sm:w-[100px] rounded-full object-contain object-center"
                                            src="<?php echo esc_url($page_profile_picture); ?>"
                                        ...
                                        if ($menu_items): ?>
                                            <?php foreach ($menu_items as $item): ?>
                                                <a href="<?php echo esc_url($item->url); ?>"
                                                    class=" text-lg font-medium leading-6 inline-flex items-center rounded-full bg-white px-4 py-1 text-black shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                        stroke-width="1.5" stroke="currentColor"
                                                        class="size-6 rtl:ml-1.5 ltr:mr-1.5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
