        ...
        foreach ($restaurant_menu as $list):
            ...
            if (!empty($list['two_column'])):
                ...
                <div class="featured-item-box pt-10 lg:pt-14" id="<?php echo esc_attr($menu_title); ?>">
                    <div class="mx-auto max-w-2xl lg:text-center page-section ltr:pl-4 rtl:pr-4 lg:rtl:pr-0 lg:pl-0 sm:pb-8 pb-3">
                    ...
                    <div class="mx-auto px-4 lg:px-6">
                        <div
                            class="grid max-full grid-cols-2 gap-4 lg:gap-6 lg:max-w-none lg:grid-cols-3 overflow-hidden rounded-[8px] lg:rounded-none">
                            ...
                            ?>
                                        <div class="">
                                            <!-- Trigger for modal -->
                                            <a href="<?php the_permalink(); ?>" class="relative flex flex-col justify-between items-stretch hover:opacity-80 <?php echo $theme_background_color ? "bg-gray-50 rounded-xl" : "" ?>"
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <?php if (!empty($item_kcal) || !empty($dietary_pref)): ?>
                                                        ...
                                                        <div class="flex flex-row items-center justify-end gap-2 absolute px-1 py-1 right-0 bottom-[0px] rounded-tl-lg rounded-br-lg bg-gray-50">
                                                ...
                                                <div class="flex-1 flex flex-col pt-2 <?php echo $theme_background_color ? "rounded-bl-xl rounded-br-xl bg-gray-50 px-2 sm:px-3 py-1 sm:py-2" : "" ?>" style="background-color:<?php echo $card_background_color ?>">
                                                    <div class="flex flex-row items-start gap-2">
                                                        ...
                                                        <?php if ($add_custom_badge): ?>
                                                            <span class="custom-badge inline-flex items-center rounded-full bg-gray-100 text-[0.7rem] font-medium mb-1" style="background-color: <?php echo esc_attr($badge_background_color ? $badge_background_color : ""); ?>">
            ...
            ?>
                <div class="menu-container-inner pt-10 lg:pt-14 px-2" id="<?php echo esc_attr($menu_title); ?>">
                    <div class="mx-auto max-w-2xl lg:text-center page-section ltr:pl-2 rtl:pr-2 lg:rtl:pr-0 lg:pl-0 pb-4 sm:pb-8">
                        <h2 class="text-3xl font-semibold sm:text-4xl">
                            <?php echo esc_html($menu_title); ?>
                        </h2>
                        <?php if ($menu_content): ?>
                        ...
                        <div class="standard-menu grid max-full <?php echo $theme_background_color ? "divide-y-0" : "" ?> divide-y grid-cols-1 lg:gap-x-6 gap-y-2 sm:gap-y-4 lg:gap-y-2
                            ...
                            <?php if (!empty($list['items']) && is_array($list['items'])):
                                ...
                                foreach ($list['items'] as $item):
                                    ...
                                    if (!$availability):
                            ?>
                                        <div class="standard-menu-item <?php echo $theme_background_color ? "rounded-xl bg-gray-50" : "" ?>" style="background-color:<?php echo $card_background_color ?>">
