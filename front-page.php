...
<main id="primary" class="min-h-screen bg-slate-50">
  ...
  <section id="tab-funnels" class="tab-panel relative">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      <div class="mb-4 flex items-center justify-between gap-4">
        <h2 class="text-2xl sm:text-3xl font-bold text-slate-900">Latest Funnels</h2>
  ...
  <section id="tab-products" class="tab-panel relative hidden">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      <div class="mb-4 flex items-center justify-between gap-4">
        <h2 class="text-2xl sm:text-3xl font-bold text-slate-900">Latest Products</h2>
            ...
            <tbody class="divide-y divide-slate-100">
              ...
              ?>
                <tr class="hover:bg-slate-50">
                  ...
                  <td class="px-4 py-3 align-top text-sm"><?php echo $shop_display; // safe html ?></td>
                  <td class="px-4 py-3 align-top text-sm"><?php echo $landers_display; // safe html ?></td>
